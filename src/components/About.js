      ...
      <div className="container">
        ...
        <div className="about-info">
          ...
          <p>
            ...
            incidunt voluptatibus eligendi odio nulla expedita optio distinctio
            ea, id perferendis qui? Lorem ipsum, dolor sit amet consectetur
            adipisicing elit. Laborum pariatur nostrum facere suscipit?
            Voluptatibus molestias aliquid numquam rerum animi unde?
          </p>
          ...
          <ul className="contact-list">
            ...
            <li>
              <span>GitHub:</span>
              <a href="https://github.com/Broncs"> https://github.com/Broncs</a>
            </li>
          </ul>
        </div>
